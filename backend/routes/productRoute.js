...
const { getAllProducts, createProduct, updateProduct, deleteProduct,getProductDetails, createProductReview,getSingleProductReviews, deleteReview, getProductCategory } = require('../controllers/productController');
